...
| Admin workstation | Targeted administrator uses compliant and noncompliant Windows devices | CA102 accepts the compliant device and reports failure for the noncompliant device |
