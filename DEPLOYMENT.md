...
The repository contains 30 Report-only Conditional Access templates, 16 group templates, stable migration mappings, and five capability packages.
...
2. Import the 16 files under `Config/Groups`.
...
|---:|---|---|
| 1 | Core Identity and External Access | MFA, registration, device code, authentication transfer, B2B collaboration, and trusted egress pass |
...
Promote one package at a time. Do not assign packages 3–5 without their named licence and service prerequisites.
